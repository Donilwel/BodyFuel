...
| Метод | Путь | Авторизация | Описание |
|-------|------|:-----------:|----------|
| `POST` | `/feedback` | — | Отправить обратную связь на email администратора |

**Запрос** `POST /feedback`
```json
{
  "message": "Текст сообщения (минимум 10, максимум 2000 символов)",
  "email": "user@example.com"
}
```

Поле `email` опциональное — если указано, будет включено в письмо.
...
**Ошибки**
- `400` — неверный формат запроса или сообщение короче 10 символов
