...
// )
//
// // ── inline mocks for TasksRepository and TransactionManager ───────────────
//
...
//		txm := mocks.NewTransactionManager(nil)
...
//		_ = txm
//
//		// Use a real passthrough transaction manager.
//		return &Service{
...
//	t := entities.NewTask(entities.WithTaskRestoreSpec(entities.TaskRestoreSpecification{
//		UUID:        id,
//		TypeNm:      taskType,
...
//	task.Failed() // mark it failed first
//
//	repo := &mockTasksRepository{}
