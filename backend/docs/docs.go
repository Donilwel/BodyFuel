    ...
    "paths": {
        ...
        "/workouts": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Параметры генерации тренировки",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.GenerateWorkoutRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/workouts/history": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "История тренировок пользователя",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "array",
        ...
        "/workouts/{uuid}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Детальная информация о тренировке",
                        "schema": {
                            "$ref": "#/definitions/models.WorkoutResponse"
                        }
                    },
        ...
        "models.GenerateWorkoutRequest": {
            ...
            "properties": {
                ...
                "level": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/entities.WorkoutsLevel"
                        }
                    ]
                },
                "place_exercise": {
